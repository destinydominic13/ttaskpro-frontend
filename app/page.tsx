...
const services = [
  { icon: Sparkles, title: 'Easy Cleaning', desc: 'Spotless homes handled by vetted, professional cleaners you can trust.' },
  { icon: Wrench, title: 'Best Plumbing', desc: 'Fast, reliable plumbing repairs and installations, done right the first time.' },
  { icon: Zap, title: 'Smart Electrical', desc: 'Licensed electricians for safe wiring, fixtures, and quick fault fixes.' },
  { icon: PaintRoller, title: 'Cool Painting', desc: 'Fresh, flawless finishes from experienced painters for any room.' },
];

const whyChoose = [
  { icon: ShieldCheck, title: 'Verified Pros', desc: 'Every provider is identity-checked and reviewed before taking bookings.' },
  { icon: Clock, title: 'Quick Service', desc: 'Most providers respond within minutes so you are never left waiting.' },
  { icon: Wallet, title: 'Secure Payments', desc: 'Funds stay safe in your wallet and release only when the job is done.' },
  { icon: Truck, title: 'Fast Delivery', desc: 'Get matched with nearby pros for same-day help when you need it.' },
  { icon: CalendarCheck, title: 'Online Booking', desc: 'Book, reschedule, and track your tasks from a single dashboard.' },
  { icon: Headphones, title: '24/7 Support', desc: 'Our team is on hand around the clock to keep every job on track.' },
];

const experts = [
  { name: 'Rosalina D. William', role: 'Lead Cleaner', img: '/images/expert-2.png' },
  { name: 'Gilima B. Bumbled', role: 'Master Plumber', img: '/images/expert-1.png' },
  { name: 'Humble H. Hiliam', role: 'Electrician', img: '/images/expert-3.png' },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
            <div className="py-20 md:py-28 max-w-xl">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed text-pretty">
                Connect with verified professionals for cleaning, plumbing, electrical work and
                more — booked and paid for safely in one place.
              </p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 left-6 right-6 sm:left-10 sm:right-auto bg-accent text-accent-foreground rounded-2xl px-6 py-4 shadow-lg flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide opacity-80">Make A Call</p>
          ...
          <div>
            <span className="text-accent font-bold uppercase tracking-wide text-sm">24/7 We Are Here</span>
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-card border border-border rounded-3xl p-8 md:p-10 shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              TTaskPro connects you with trusted, background-checked professionals for every task
              around your home and business. From a quick fix to a full project, the right pro is
              only a few taps away.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              Every booking is protected with secure payments and transparent reviews, so you can
              hire with total peace of mind.
            </p>
            <div className="flex items-center gap-4 border-t border-border pt-6">
              ...
              />
              <div>
                <p className="font-bold text-card-foreground">Rosalina D. William</p>
      ...
      <section id="booking" className="px-6 py-20 md:py-24 max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <span className="text-accent font-bold uppercase tracking-wide text-sm">Booking</span>
        ...
        <div className="bg-card border border-border rounded-3xl shadow-sm p-6 md:p-10">
          <p className="text-center font-bold text-primary mb-6">Service Information</p>
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            {['1 Task', '2 Tasks', '3 Tasks', '4 Tasks', 'Custom'].map((opt, i) => (
              <span
                key={opt}
      ...
      <section className="px-6 py-20 md:py-24 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <span className="text-accent font-bold uppercase tracking-wide text-sm">Works</span>
          <h2 className="text-3xl md:text-4xl font-black text-primary mt-2 text-balance">
            Our Portfolio
          </h2>
        </div>
      ...
      <section id="experts" className="bg-primary px-6 py-20 md:py-24">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              <span className="text-accent font-bold uppercase tracking-wide text-sm">Workers</span>
              <h2 className="text-3xl md:text-4xl font-black text-primary-foreground mt-2 text-balance">
                Our Experts
              </h2>
            </div>
            <div className="hidden sm:flex items-center gap-3">
              <button className="size-11 rounded-full border border-primary-foreground/30 text-primary-foreground flex items-center justify-center hover:bg-primary-foreground/10 transition-colors" aria-label="Previous">
                <ArrowLeft className="size-5" />
              </button>
              <button className="size-11 rounded-full bg-accent text-accent-foreground flex items-center justify-center hover:opacity-90 transition-opacity" aria-label="Next">
                <ArrowRight className="size-5" />
              </button>
            </div>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {experts.map((e) => (
              <div key={e.name} className="bg-card rounded-3xl overflow-hidden shadow-sm">
                <img src={e.img || '/placeholder.svg'} alt={e.name} className="w-full h-72 object-cover" />
      ...
      <section id="news" className="px-6 py-20 md:py-24 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <span className="text-accent font-bold uppercase tracking-wide text-sm">News</span>
          <h2 className="text-3xl md:text-4xl font-black text-primary mt-2 text-balance">
            Get Every Update
          </h2>
        </div>
        <div className="grid lg:grid-cols-3 gap-6">
          {news.map((n) => (
            <article key={n.title} className="bg-card border border-border rounded-3xl overflow-hidden shadow-sm">
              <img src={n.img || '/placeholder.svg'} alt={n.title} className="w-full h-52 object-cover" />
              <div className="p-6">
                <div className="flex items-center gap-2 text-sm text-accent font-semibold mb-3">
                  <Calendar className="size-4" />
                  {n.date}
                </div>
                <h3 className="text-lg font-bold text-primary leading-snug text-pretty">{n.title}</h3>
                <Link href="/register" className="inline-flex items-center gap-1 text-sm font-semibold text-primary mt-4 hover:underline">
          ...
          <div className="bg-primary rounded-3xl p-8 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="text-accent font-bold uppercase tracking-wide text-sm">Call To Action</span>
              ...
              <p className="text-primary-foreground/70 mb-6 leading-relaxed">
                Join thousands of happy customers and book your first task today.
              </p>
              <Link
                href="/register"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
              ...
              <p className="text-primary-foreground/70 leading-relaxed text-sm mb-6">
                The trusted marketplace connecting you with verified professionals for every task
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-primary-foreground/70">
                ...
                <li><a href="#experts" className="hover:text-accent transition-colors">Our Experts</a></li>
                <li><a href="#news" className="hover:text-accent transition-colors">News &amp; Blog</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-primary-foreground/70">
                <li className="flex items-center gap-2">
                  <Clock className="size-4 text-accent" /> Mon – Fri: 8:00 – 18:00
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  <MapPin className="size-4 text-accent" /> 24 Service Street, Lagos
                </li>
              </ul>
            </div>
